...
public class CarrerasTecnicasController implements Initializable {
    ...
    public ObservableList getCarrerasTecnicas() {
        ...
        try {
            ...
            System.err.println("\n Se produjo un error al intentar consultar la lista de Carreras Técnicas");
            e.printStackTrace();
        ...
        switch (operacion) {
            ...
            case GUARDAR:
                if (txtCodigoTecnico.getText().isEmpty()) {
                    ...
                    alert.setContentText("El campo Código Técnico es obligatorio");
                    ...
                    alert.setTitle("Control Académico Kinal");
                    alert.setHeaderText(null);
                    alert.setContentText("El campo Carrera es obligatorio");
                    Stage dialog = new Stage();
                    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
                    stage.getIcons().add(new Image(PAQUETE_IMAGES + "logo.png"));
                    alert.show();
                    ...
                    alert.setTitle("Control Académico Kinal");
                    alert.setHeaderText(null);
                    alert.setContentText("El campo Grado es obligatorio");
                    Stage dialog = new Stage();
                    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
                    stage.getIcons().add(new Image(PAQUETE_IMAGES + "logo.png"));
                    alert.show();
                } else if (txtSeccion.getText().isEmpty() || txtSeccion.getText().contentEquals("")) {
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setTitle("Control Académico Kinal");
                    alert.setHeaderText(null);
                    alert.setContentText("El campo Sección es obligatorio, solo acepta una letra");
                    Stage dialog = new Stage();
                    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
                    stage.getIcons().add(new Image(PAQUETE_IMAGES + "logo.png"));
                    alert.show();
                    ...
                    alert.setTitle("Control Académico Kinal");
                    alert.setHeaderText(null);
                    alert.setContentText("El campo Jornada es obligatorio");
                    Stage dialog = new Stage();
                    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
                    stage.getIcons().add(new Image(PAQUETE_IMAGES + "logo.png"));
                    alert.show();
    ...
    // Ver si funciona el enlace entre ventanass
